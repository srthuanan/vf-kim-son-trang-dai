...
const sql = `
create or replace function public.rpc_hold_car_v2(
  p_vin text,
  p_username text,
  p_full_name text
)
...
grant execute on function public.rpc_hold_car_v2(text, text, text) to authenticated;
grant execute on function public.rpc_hold_car_v2(text, text, text) to anon;

NOTIFY pgrst, 'reload schema';
`;

async function applySql() {
  console.log('Applying SQL for V2...');
  try {
